  ...
  return (
    ...
    <div className="max-w-3xl mx-auto">
      <div className="grid grid-cols-1 gap-6">
          ...
          <Card className="bg-card">
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                {/* BASIC INFO: USERNAME, NAME, BIO, AND AVATAR */}
                ...
                {/* PROFILE STATS (FOLLOWERS, FOLLOWING, and POSTS COUNTS) */}
                <div className="w-full mt-6">
                  <div className="flex justify-between mb-4">
                    ...
                    <div>
                      <div className="font-semibold">{user._count.follower.toLocaleString()}</div>
        ...
        {/* EDIT PROFILE DIALOG (NAME, BIO, WEBSITE, LOCATION) */}
